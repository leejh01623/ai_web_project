...
function gotombtiTest1Page() {
	let filter = 'win16|win32|win64|mac|macintel';
	if (0 > filter.indexOf(navigator.platform.toLowerCase())) {
		//console.log("Client platform : Mobile");
		location.href =
			'intent://playzapangi.netlify.app/mbtiTest1/mbtiTest1Desc.html#Intent;scheme=http;package=com.android.chrome;end';
		//location.href = "picturediary.html";
	} else {
		//console.log("Client platform : PC");
...
function gotospaceGamePage() {
	let filter = 'win16|win32|win64|mac|macintel';
	if (0 > filter.indexOf(navigator.platform.toLowerCase())) {
		//console.log("Client platform : Mobile");
		location.href =
			'intent://playzapangi.netlify.app/spaceGame/spaceGame.html#Intent;scheme=http;package=com.android.chrome;end';
		//location.href = "picturediary.html";
	} else {
		//console.log("Client platform : PC");
...
function gotoinstantMemoryTestPage() {
	let filter = 'win16|win32|win64|mac|macintel';
	if (0 > filter.indexOf(navigator.platform.toLowerCase())) {
		//console.log("Client platform : Mobile");
		location.href =
			'intent://playzapangi.netlify.app/instantMemoryTest/instantMemoryTestDesc.html#Intent;scheme=http;package=com.android.chrome;end';
		//location.href = "picturediary.html";
	} else {
		//console.log("Client platform : PC");
